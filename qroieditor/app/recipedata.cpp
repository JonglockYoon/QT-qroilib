...
Qroilib::ParamTable paramTable[] = {
    ...
    _Inspect_Patt_Identify,  CParam(_ProcessValue1, ("Noise out 3"), _IntValue, ("0")),	
    ...
    _Inspect_Roi_Find_Shape,  CParam(_ProcessValue1, ("Noise out 3"), _IntValue, ("0")),
    _Inspect_Roi_Find_Shape,  CParam(_DecideValue, ("EPS"), _DoubleValue, ("0.05")),
    ...
    _Inspect_Point_Coordnation,  CParam(_ProcessValue1, ("Mark color"), _IntValue, ("128")), // mark color - not yet implement.
...
{
    m_sInspList[_Inspect_Patt_Identify].sprintf(("Pattern find"));
