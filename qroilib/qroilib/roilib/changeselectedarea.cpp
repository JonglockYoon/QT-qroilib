...
ChangeSelectedArea::ChangeSelectedArea(DocumentView *mapDocument,
...
{
    const QRegion oldSelection = mRoiDocument->selectedArea();
    mRoiDocument->setSelectedArea(mSelection);
