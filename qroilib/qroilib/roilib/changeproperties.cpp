...
ChangeProperties::ChangeProperties(DocumentView *document,
                                   const QString &kind,
                                   Object *object,
...
SetProperty::SetProperty(DocumentView *document,
...
RemoveProperty::RemoveProperty(DocumentView *document,
                               const QList<Object*> &objects,
                               const QString &name,
                               QUndoCommand *parent)
    : QUndoCommand(parent)
...
RenameProperty::RenameProperty(DocumentView *document,
                               const QList<Object*> &objects,
