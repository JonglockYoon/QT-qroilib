...
public:
     ...
     * @param kind         the kind of properties (RoiMap, Layer, Object, etc.)
     ...
     */
    ChangeProperties(DocumentView *document,
                     const QString &kind,
                     Object *object,
...
public:
     ...
     */
    SetProperty(DocumentView *document,
...
public:
     ...
     */
    RemoveProperty(DocumentView *document,
                   const QList<Object*> &objects,
                   const QString &name,
                   QUndoCommand *parent = nullptr);
...
public:
     ...
     */
    RenameProperty(DocumentView *document,
                   const QList<Object*> &objects,
