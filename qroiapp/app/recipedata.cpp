...
Qroilib::ParamTable paramTable[] = {
    ...
    _Inspect_Roi_Screw,  CParam(_ProcessValue1, ("Low Threshold"), _IntValue, ("0")),
    _Inspect_Roi_Screw,  CParam(_ProcessValue1, ("High Threshold"), _IntValue, ("100")),
    _Inspect_Roi_Screw,  CParam(_ProcessValue1, ("Noise out 1"), _IntValue, ("1")),	// -1 : Open - 작은 White blob 들을 없앤다.
    _Inspect_Roi_Screw,  CParam(_ProcessValue1, ("Noise out 2"), _IntValue, ("-1")),	// 1 : Close - White blob 들을 묶는다..
    _Inspect_Roi_Screw,  CParam(_ProcessValue1, ("Noise out 3"), _IntValue, ("0")),	// -1 : Open - 작은 White blob 들을 없앤다.
    _Inspect_Roi_Screw,  CParam(_ProcessValue2, ("Low Threshold"), _IntValue, ("0")),
    _Inspect_Roi_Screw,  CParam(_ProcessValue2, ("High Threshold"), _IntValue, ("0")),
    _Inspect_Roi_Screw,  CParam(_ProcessValue2, ("Noise out 1"), _IntValue, ("1")),	// -1 : Open - 작은 White blob 들을 없앤다.
    _Inspect_Roi_Screw,  CParam(_ProcessValue2, ("Noise out 2"), _IntValue, ("-1")),	// 1 : Close - White blob 들을 묶는다..
    _Inspect_Roi_Screw,  CParam(_ProcessValue2, ("Noise out 3"), _IntValue, ("0")),	// -1 : Open - 작은 White blob 들을 없앤다.
    _Inspect_Roi_Screw,  CParam(_ProcessValue3, ("Low Threshold"), _IntValue, ("0")),
    _Inspect_Roi_Screw,  CParam(_ProcessValue3, ("High Threshold"), _IntValue, ("0")),
    _Inspect_Roi_Screw,  CParam(_ProcessValue3, ("Noise out 1"), _IntValue, ("1")),	// -1 : Open - 작은 White blob 들을 없앤다.
    _Inspect_Roi_Screw,  CParam(_ProcessValue3, ("Noise out 2"), _IntValue, ("-1")),	// 1 : Close - White blob 들을 묶는다..
    _Inspect_Roi_Screw,  CParam(_ProcessValue3, ("Noise out 3"), _IntValue, ("0")),	// -1 : Open - 작은 White blob 들을 없앤다.
    _Inspect_Roi_Screw,  CParam(_PostProcessValue1, ("Noise out 1"), _IntValue, ("0")),
    _Inspect_Roi_Screw,  CParam(_PostProcessValue1, ("Noise out 2"), _IntValue, ("0")),
    _Inspect_Roi_Screw,  CParam(_DecideValue, ("Fill area rate"), _DoubleValue, ("60.0")),
    _Inspect_Roi_Screw,  CParam(_DecideValue, ("Roundness accuracy rate"), _DoubleValue, ("60.0")),
    _Inspect_Roi_Screw,  CParam(_DecideValue, ("Minimum circle radius"), _DoubleValue, ("18.0")),
    _Inspect_Roi_Screw,  CParam(_DecideValue, ("Maximum circle radius"), _DoubleValue, ("80.0")),
    _Inspect_Roi_Screw,  CParam(_LightValue, ("Light"), _IntValue, ("100")),
...
void CRecipeData::InitParamData()
{
    ...
    m_sInspList[_Inspect_Roi_Screw].sprintf(("Screw"));
    ...
    //m_sInspList[_Inspect_Roi_Circle_With_Edge].Format(("Circle with Edge"));
...
{
//    for (int i = 0; i< (int)m_vecRoiObject.size(); i++)
//    {
//        RoiObject* pData = m_vecRoiObject[i];
