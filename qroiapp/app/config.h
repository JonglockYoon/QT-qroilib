...
public:
    ...
    QString m_sInterfacePort;
    QString m_sLightPort;

    QString m_sCamera1;
    QString m_sCamera2;

    int m_nAlignMode; // 1:1Point, 2:2Point, 3-All Point
    int m_nCamExposure;

    double feducial_vision_x;
    double feducial_vision_y;
    double feducial_vision_z;
    double feducial_screw_x;
    double feducial_screw_y;
    double feducial_screw_z;
    double feducial_offset_x;
    double feducial_offset_y;

    double vision_offset_z;
