...
static const char * sType = "Integer";

class ObjectPrivate;
class Object final : public InodeValue::Object<qint64> , public Integer::Interface
{
...
public:
    ...
    Integer::Interface *interface() override final;
    const Integer::Interface *constInterface() const override final;
