...
static const char * sType = "Converter";

class ObjectPrivate;
class Object final : public InodeConverter::Object, public Float::Interface
{
...
public:
    ...
    int getPollingTime() const override;
