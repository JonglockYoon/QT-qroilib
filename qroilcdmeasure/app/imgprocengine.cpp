...
int CImgProcEngine::MakeMaskUsingCannyEdge(RoiObject *pData, IplImage* grayImg, int nDbg)
{
    QString str;
    try {
...
#define RM 4
    ...
    for (int i = 0; i < nBlobs; i++)
    {
        ...
        oldpt2 = pt2;
        //
        // Make Mask using CannyEdge
        //
        cvCopy(croppedImage, tmp);
        MakeMaskUsingCannyEdge(pData, tmp, i);
        cvResetImageROI(croppedImage);

        // Make Mask using Blob
        CBlobResult blobs1;
