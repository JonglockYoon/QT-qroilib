...
Qroilib::ParamTable paramTable[] = {
    ...
    _Inspect_Roi_EdgeWithThreshold,  CParam(_ProcessValue1, ("Direction"), _ComboValue, ("0"), ("Left2Right,Right2Left,Top2Bottom,Bottom2Top")),
    _Inspect_Roi_EdgeWithThreshold,  CParam(_ProcessValue1, ("Polarity"), _ComboValue, ("0"), ("White2Black,Black2White")),
    _Inspect_Roi_EdgeWithThreshold,  CParam(_ProcessValue1, ("Low Threshold"), _IntValue, ("50")),
    _Inspect_Roi_EdgeWithThreshold,  CParam(_ProcessValue1, ("High Threshold"), _IntValue, ("255")),
    _Inspect_Roi_EdgeWithThreshold,  CParam(_ProcessValue1, ("Invert?"), _ComboValue, ("0"), ("No,Yes")),
    _Inspect_Roi_EdgeWithThreshold,  CParam(_ProcessValue1, ("Noise out 1"), _IntValue, ("3")),	// -1 : Open - 작은 White blob 들을 없앤다
    _Inspect_Roi_EdgeWithThreshold,  CParam(_ProcessValue1, ("Noise out 2"), _IntValue, ("0")),	// 1 : Close - White blob 들을 묶는다.
    _Inspect_Roi_EdgeWithThreshold,  CParam(_ProcessValue1, ("Expansion 1"), _IntValue, ("0")),	// -1 : Erode - 침식연산
    _Inspect_Roi_EdgeWithThreshold,  CParam(_ProcessValue1, ("Expansion 2"), _IntValue, ("0")),	// 1 : Dilate - 팽창연산
    _Inspect_Roi_EdgeWithThreshold,  CParam(_PriorityValue, ("Priority"), _IntValue, ("10")),

    _Inspect_Roi_SubpixelEdge,  CParam(_ProcessValue1, ("Direction"), _ComboValue, ("0"), ("Left2Right,Right2Left,Top2Bottom,Bottom2Top")),
...
{
    m_sInspList[_Inspect_Roi_EdgeWithThreshold].sprintf(("Edge with Threshold"));
    m_sInspList[_Inspect_Roi_SubpixelEdge].sprintf(("Subpixel Edge"));
